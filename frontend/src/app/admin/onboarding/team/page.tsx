  ...
  const roles: Role[] = [
    {
      ...
      description:
        'System configuration, user management, integrations & monitoring',
      permissions: [
    ...
    },
    {
      ...
      description:
        'Property data entry, financial operations & tenant management',
      permissions: [
        'manage_properties',
        'manage_tenants',
        'manage_contracts',
    ...
    },
    {
      id: 'owner',
      name: 'Property Owner',
      description: 'Portfolio monitoring, expense approvals & ROI tracking',
      permissions: [
    ...
    },
    {
      ...
      name: 'Tenant',
      description:
        'Rent payments, maintenance requests & lease information access',
      permissions: [
        'pay_rent',
